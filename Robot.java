...
public class Robot {
  ...
  public Robot(){
    ...
    pump7 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_07, "My Led", PinState.HIGH);
    pump8 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_08, "My Led", PinState.HIGH);
    pump9 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_09, "My Led", PinState.HIGH);
    pump10 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_10, "My Led", PinState.HIGH);
    pump11 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_11, "My Led", PinState.HIGH);
    pump12 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_12, "My Led", PinState.HIGH);
    pump13 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_13, "My Led", PinState.HIGH);
    pump14 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_14, "My Led", PinState.HIGH);
